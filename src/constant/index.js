export const about_us_content = [
  {
    title: "About Us",
    content:
      "Calibration Service Provider, incorporated under the companies and allied matter ACT.1990 Vide certificate of incorporation dated may 18, 1993 bearing number RC:222:134 in Abuja, Nigeria and DPR licensed.",
    content_2:
...
export const where_choose_us_content = [
  {
    icon: "fa-solid fa-certificate",
    title: "Certified Technicians",
    content:
      "Our team is highly trained and certified to handle a wide range of instruments.",
  },
  {
    icon: "fa-solid fa-arrows-rotate",
    title: "Fast Turnaround",
    content:
      "We respect your time and deliver results efficiently without compromising accuracy.",
  },
  {
    icon: "fa-solid fa-users-gear",
    title: "Customer-Centric Approach",
    content:
      "We prioritize our clients' needs and work closely with them to provide tailored solutions. We offer both in-house and on-site calibration based on your needs.",
  },
];
...
export const services = [
  ...
  },
  {
    ...
    content: [
      ...
      "Meter calibration/proofing",
      "Metering system upgrade/auditing",
      "Dispensing pumps calibration and general service",
    ],
